...
export const NetworkTelemetryChart: React.FC<NetworkTelemetryChartProps> = ({
  ...
  const endpoints: EndpointConfig[] = useMemo(
    () => [
      ...
      {
        id: 'ep_shots_create',
        name: 'Shot Provisioning',
        category: 'GrabBox Pipeline',
        method: 'POST',
        path: '/shots',
        description: 'Supervisor shot creation and task provisioning.',
      },
      {
        id: 'ep_shots_reclaim',
        name: 'Reclaim Expired',
        category: 'GrabBox Pipeline',
        method: 'POST',
        path: '/shots/reclaim-expired',
        description: 'Automatic claim expiry and timeout sweep.',
      },
      {
        id: 'ep_reviews_list',
        name: 'Review Desk',
