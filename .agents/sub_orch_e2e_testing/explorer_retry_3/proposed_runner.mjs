...
for (const tierNum of validTiers) {
  ...
  for (const file of files) {
    ...
    try {
      ...
      console.error(`\x1b[31m[FATAL] Failed to import test file "${file}":\x1b[0m`, err);
      process.exit(1);
    }
  }
}
...
// 4. Run harness with robust exception protection
try {
  ...
  console.error(`\n\x1b[31m================================================================================\x1b[0m`);
  console.error(`\x1b[31m[FATAL] Test runner crashed with an unhandled exception:\x1b[0m`);
  console.error(`\x1b[31m================================================================================\x1b[0m`);
  console.error(fatalErr?.stack || fatalErr);
  process.exit(1);
}
